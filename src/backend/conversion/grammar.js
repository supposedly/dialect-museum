...
var grammar = {
    ...
    {"name": "stem", "symbols": ["initial_syllable", "stem$ebnf$1", "last_three_syllables"], "postprocess": ([a, b, { stressedOn, value: c }]) => _.obj(`stem`, { stressedOn }, [a, ...b, ...c])},
    ...
    {"name": "disyllable", "symbols": ["penult_stress_disyllable"], "postprocess": ([value]) => ({ stressedOn: -2, value })},
    {"name": "disyllable", "symbols": ["final_stress_disyllable"], "postprocess": ([value]) => ({ stressedOn: -1, value })},
    ...
    {"name": "trisyllable", "symbols": ["antepenult_stress_trisyllable"], "postprocess": ([value]) => ({ stressedOn: -3, value })},
    {"name": "trisyllable", "symbols": ["initial_syllable", "stressed_penult_last_two"], "postprocess": ([a, b]) => ({ stressedOn: -2, value: [a, ...b] })},
    {"name": "trisyllable", "symbols": ["initial_syllable", "stressed_final_last_two"], "postprocess": ([a, b]) => ({ stressedOn: -1, value: [a, ...b] })},
    ...
    {"name": "last_three_syllables", "symbols": ["antepenult_stress_triplet"], "postprocess": ([value]) => ({ stressedOn: -3, value })},
    {"name": "last_three_syllables", "symbols": ["medial_syllable", "stressed_penult_last_two"], "postprocess": ([a, b]) => ({ stressedOn: -2, value: [a, ...b] })},
    {"name": "last_three_syllables", "symbols": ["medial_syllable", "stressed_final_last_two"], "postprocess": ([a, b]) => ({ stressedOn: -1, value: [a, ...b] })},
